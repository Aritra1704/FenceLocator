package com.arpaul.fencelocator.service;
...
import com.arpaul.fencelocator.activity.GeoFenceActivity;
...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected static final  String TAG = "GeofenceTransitionsIntentService.is";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofencingEvent.hasError()) {
            ...
            LogUtils.errorLog(TAG, errorMessage);
            return;
        }
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            LogUtils.infoLog(TAG, geofenceTransitionDetails);
        } else {
            // Log the error.
            LogUtils.errorLog(TAG, getString(R.string.geofence_transition_invalid_type, geofenceTransition));
        }
    }
